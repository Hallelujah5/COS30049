  ...
  if (!user) {
    ...
    <div className="search-container">
      <svg className='search-icon' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input class="form-control mr-sm-2" id='searchbar' className='outfit' type="search" placeholder="Search" aria-label="Search" />
    </div>
      <Link to="/profile"><img src={userIcon} alt="White user icon" id='user-icon' /></Link>   
    </form>
